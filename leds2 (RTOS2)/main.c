...
// Tavoite pistemäärä: 2p
// dispatcher lukee fifo-puskuria ja käy läpi sekvenssin
// uart_task vantaanottaa kirjaimia ja kerää ne bufferiin ja fifoon
//napi myös pystyvät lisäämään sekvenssiin kirjaimia
